...
parser.add_argument("--depth", type=int, default=4, help='max depth for decision-tree classifier')
...
if(model_name == 'dt'):
    model, data_train, data_test,sensitive_attributes, y_train, y_test = decision_tree_wrap.init(datasetObj, repaired=False, verbose=False, compute_equalized_odds=True, depth=args.depth)
